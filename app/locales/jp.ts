...
const jp: PartialLocaleType = {
  ...
  Store: {
    ...
    BotAbout:
      "このプラットフォームは、[余弦(よずる)](https://yozuru.cn/)によって[ChatGPT Next](https://github.com/Yidadaa/ChatGPT-Next-Web)をベースに構築され、個人および身近な友人にサービスを提供するために存在しています。会話ごとに**料金が発生**するため、無意味な対話は避けてください（もちろん、楽しく遊ぶことは有意義です）。" +
